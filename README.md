...
| Platform | Minimum |
| --- | --- |
| **Windows 10/11 · Linux x86_64/arm64** | An NVIDIA GPU from the RTX 20 series or newer (Turing, compute capability 7.5) with 8 GB of VRAM, and a current NVIDIA driver. The Windows installer ships the CUDA runtime it needs; on Linux, install it yourself — 12.8 on x86_64, 13.0 on arm64. |
