...
echo cmake-arg -DLLAMA_BUILD_NUMBER=%PIN_BUILD%>> "%BUILD_DIR%\IDLETOKEN_ENGINE_STAMP"
echo cmake-arg -DLLAMA_BUILD_COMMIT=%PIN7%>> "%BUILD_DIR%\IDLETOKEN_ENGINE_STAMP"
echo cmake-arg -DGGML_RPC=ON>> "%BUILD_DIR%\IDLETOKEN_ENGINE_STAMP"
echo cmake-arg -DGGML_RPC_TLS=ON>> "%BUILD_DIR%\IDLETOKEN_ENGINE_STAMP"
echo cmake-arg -DIDLETOKEN_MBEDTLS_SRC=%IDLETOKEN_MBEDTLS_SRC%>> "%BUILD_DIR%\IDLETOKEN_ENGINE_STAMP"
echo cmake-arg -DGGML_STATIC=ON>> "%BUILD_DIR%\IDLETOKEN_ENGINE_STAMP"
echo cmake-arg -DBUILD_SHARED_LIBS=OFF>> "%BUILD_DIR%\IDLETOKEN_ENGINE_STAMP"
echo cmake-arg -DGGML_NATIVE=OFF>> "%BUILD_DIR%\IDLETOKEN_ENGINE_STAMP"
echo cmake-arg -DGGML_SSE42=OFF>> "%BUILD_DIR%\IDLETOKEN_ENGINE_STAMP"
echo cmake-arg -DGGML_AVX=OFF>> "%BUILD_DIR%\IDLETOKEN_ENGINE_STAMP"
echo cmake-arg -DGGML_AVX2=OFF>> "%BUILD_DIR%\IDLETOKEN_ENGINE_STAMP"
echo cmake-arg -DGGML_BMI2=OFF>> "%BUILD_DIR%\IDLETOKEN_ENGINE_STAMP"
echo cmake-arg -DLLAMA_CURL=OFF>> "%BUILD_DIR%\IDLETOKEN_ENGINE_STAMP"
echo cmake-arg -DLLAMA_OPENSSL=OFF>> "%BUILD_DIR%\IDLETOKEN_ENGINE_STAMP"
echo cmake-arg -DLLAMA_BUILD_UI=OFF>> "%BUILD_DIR%\IDLETOKEN_ENGINE_STAMP"
echo cmake-arg -DLLAMA_USE_PREBUILT_UI=OFF>> "%BUILD_DIR%\IDLETOKEN_ENGINE_STAMP"
echo cmake-arg -DLLAMA_BUILD_TESTS=OFF>> "%BUILD_DIR%\IDLETOKEN_ENGINE_STAMP"
echo cmake-arg -DLLAMA_BUILD_EXAMPLES=OFF>> "%BUILD_DIR%\IDLETOKEN_ENGINE_STAMP"
