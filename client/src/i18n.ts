...
export const STRINGS = {
  en: {
    ...
    "share.on": "Sharing",
    "share.opening": "Opening sharing",
    "share.reconnecting": "Reconnecting sharing",
    "share.failed": "Could not start sharing",
    "share.agentStopped": "The sharing agent stopped. Try opening sharing again.",
    "share.startTimeout": "The platform did not confirm sharing within 60 seconds. Check your connection and try again.",
    "share.unlisted": "The platform did not list this service. Try opening sharing again.",
    ...
    "weights.verifying": "Verifying: {have} / {total}",
    "weights.verifyingPart": "Verifying part {part}/{parts}: {have} / {total}",
    ...
    "pairing.moeResources": "GPU {gpu} · MoE RAM {ram}",
    ...
    "spine.no": "Available memory may fall short.",
    "spine.clusterFits": "These {n} machines can hold the whole model.",
    "spine.hybridFits": "VRAM and memory both meet the estimated minimum.",
    "spine.hybridReading": "Reading the downloaded model's exact expert layout…",
    "spine.hybridDownload": "Download the model to calculate exact Hybrid requirements.",
    "spine.hybridUnavailable": "Could not read the model's exact expert layout; startup will check it again.",
    ...
    "spine.unknown": "Cannot tell yet — a machine has not reported its usable resources.",
    ...
    "pairing.createNeedsCompute": "Creating a cluster requires supported compute hardware and verified local model weights.",
    ...
    "pairing.err.lanRoute":
      "Could not find a direct LAN route to the coordinator. Keep Ethernet or Wi-Fi connected; VPNs may stay enabled, but model and tensor traffic will not use them. Details: {detail}",
    ...
    "pairing.phase.starting": "Starting engines and loading the model…",
    ...
    "startup.elapsed": "Elapsed {time}",
    "startup.launching": "Starting the inference processes…",
    "startup.loadingModel": "Loading the model into memory…",
    "startup.restarting": "The inference process restarted; loading again…",
    "startup.finding": "Finding the cluster on this network…",
    "startup.clusterDetail":
      "Each machine is allocating memory and loading its assigned model layers. Large models or GPU + RAM loading can take several minutes.",
    "startup.localDetail":
      "This machine is allocating the selected context and loading model weights. Large models or GPU + RAM loading can take several minutes.",
    "startup.findingDetail":
      "Listening for the hosting machine and completing the secure pairing handshake.",
    ...
    "capacity.reserveBudget": "Budget to reserve (estimated)",
    "capacity.expertStorage": "Expert memory budget (estimated)",
    ...
    "chat.sidebar.label": "Conversations",
    ...
    "model.change": "Change",
    "model.change.paired": "Paired: leave the cluster to change the model",
    ...
    "model.pick.familyCurrent": "{n} models · current: {model}",
  ...
  zh: {
    ...
    "share.on": "分享中",
    "share.opening": "打开中",
    "share.reconnecting": "分享正在重连",
    "share.failed": "分享未能打开",
    "share.agentStopped": "分享代理已停止，请重新打开分享。",
    "share.startTimeout": "60 秒内未收到平台的分享确认，请检查网络后重试。",
    "share.unlisted": "平台未将这项服务上架，请重新打开分享。",
    ...
    "weights.verifying": "正在校验：{have} / {total}",
    "weights.verifyingPart": "正在校验第 {part}/{parts} 卷：{have} / {total}",
    "weights.err.sha256Mismatch":
    ...
    "node.threads": "{n} 线程",
    "node.unified": "统一内存",
    "pairing.moeResources": "GPU {gpu} · MoE 可用内存 {ram}",
    ...
    "spine.hybridFits": "显存和内存均达到预估最低要求。",
    "spine.hybridReading": "正在读取模型文件，精确核算专家参数…",
    "spine.hybridDownload": "下载模型后可精确核算混合运行所需资源。",
    "spine.hybridUnavailable": "暂时无法读取专家参数布局；启动时会再次精确核验。",
    "spine.unknown": "暂时无法判断——有机器还没上报可用资源。",
    ...
    "pairing.createNeedsCompute": "创建集群需要受支持的计算硬件，以及已在本机校验完成的模型权重。",
    ...
    "pairing.err.lanRoute":
      "找不到直连协调者的局域网路径。请保持网线或 Wi-Fi 已连接；VPN 可以继续开启，但模型与张量流量不会走 VPN。详情：{detail}",
    ...
    "pairing.phase.starting": "正在启动引擎并加载模型…",
    "pairing.phase.probing": "正在探测各机资源…",
    "pairing.phase.splitting": "正在把模型切分到各节点…",
    "pairing.phase.loading": "正在加载分片层…",
    "pairing.phase.ready": "集群就绪",
    "startup.elapsed": "已等待 {time}",
    "startup.launching": "正在启动推理进程…",
    "startup.loadingModel": "正在把模型加载到内存…",
    "startup.restarting": "推理进程已重启，正在重新加载…",
    "startup.finding": "正在本局域网查找集群…",
    "startup.clusterDetail":
      "各机器正在分配内存并加载自己负责的模型层；大模型或 GPU + RAM 混合加载可能需要几分钟。",
    "startup.localDetail":
      "本机正在分配所选上下文并加载模型权重；大模型或 GPU + RAM 混合加载可能需要几分钟。",
    "startup.findingDetail": "正在等待主机应答，并完成安全组网握手。",
    ...
    "capacity.reserveBudget": "需预留（预估）",
    "capacity.expertStorage": "专家内存预留（预估）",
    "stats.requests": "次请求",
    "stats.tokens": "词元",
    "stats.ctx": "上下文",
    ...
    "chat.untitled": "新对话",
    "chat.delete": "删除这个对话",
    "chat.sidebar.label": "对话列表",
    "chat.sidebar.show": "展开对话列表",
    "chat.sidebar.hide": "收起对话列表",
    "chat.reasoning": "思考过程",
    "chat.copy": "复制",
    "chat.copied": "已复制",
    "chat.regen": "重新生成",
    ...
    "model.change": "更换",
    "model.change.paired": "已组网：解散集群后才能更换模型",
    ...
    "model.pick.familyCurrent": "{n} 个模型 · 当前 {model}",
...
const ERROR_KEYS: Record<string, StringKey> = {
  ...
  SHARE_AGENT_STOPPED: "share.agentStopped",
  SHARE_START_TIMEOUT: "share.startTimeout",
  SHARE_NOT_LISTED: "share.unlisted",
